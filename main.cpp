...
int main(int argc, char* argv[])
{
    ...
    chk(SDL_Vulkan_GetPresentationSupport(
        instance,
        devices[deviceIndex],
        queueFamily
    ));
    ...
    slangGlobalSession->createSession(
        slangSessionDesc,
        slangSession.writeRef()
    );
    Slang::ComPtr<slang::IModule> slangModule{
        slangSession->loadModuleFromSource(
            "triangle",
            "assets/shader.slang",
            nullptr,
            nullptr
    ...
    while (!quit)
    {
        ...
        memcpy(
            shaderDataBuffers[frameIndex].mapped,
            &shaderData,
            sizeof(ShaderData)
        );
